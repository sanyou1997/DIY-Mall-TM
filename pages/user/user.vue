                ...
                <view :class="'user-bottom padding-horizontal-main ' + ((payment_page_url || null) !== null || (membership_page_url || null) !== null ? 'box-shadow' : '')">
                    ...
                    <view class="service-nav padding-main border-radius-main bg-white spacing-mb">
                        ...
                        <view v-if="nav_show_model_type == 1" class="nav-list">
                            ...
                            <!-- #ifdef MP-JD -->
                            <!-- 京东小程序：收货地址 -->
                            <view :class="'nav-item cp padding-main ' + (navigation.length > 0 ? 'br-t-e' : '')" data-value="/pages/user-address/user-address" @tap="url_event">
                                <view class="arrow-right">
                                    <iconfont name="icon-location" size="40rpx" color="#666" propClass="va-m"></iconfont>
                                    <text class="item-name va-m cr-base margin-left-sm text-size-sm">收货地址</text>
                                </view>
                            </view>
                            <!-- #endif -->
                            <!-- 清除缓存 -->
                        ...
                        <view v-else class="nav-box oh margin-top-sm">
                            ...
                            <!-- #ifdef MP-JD -->
                            <!-- 京东小程序：收货地址 -->
                            <view class="nav-item padding-vertical-main padding-horizontal-xs fl tc cp" data-value="/pages/user-address/user-address" @tap="url_event">
                                <view class="item-icon-wrap">
                                    <iconfont name="icon-location" size="48rpx" color="#666"></iconfont>
                                </view>
                                <view class="item-name single-text cr-base text-size-sm">收货地址</view>
                            </view>
                            <!-- #endif -->
                            <!-- 清除缓存 -->
